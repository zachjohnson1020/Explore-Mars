...
def marshome(request):
    ...
    ApodApi= requests.get('https://api.nasa.gov/planetary/apod?api_key=qUqVD3egPAFhfMAalWdyMW6hdYCLz9qYdjmc4JCl')
    ...
    roverApi= requests.get('https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?earth_date=2023-10-10&camera=NAVCAM&api_key=qUqVD3egPAFhfMAalWdyMW6hdYCLz9qYdjmc4JCl')
